...
class FeatsDistLossPluginMetric(GenericPluginMetric[float]):
    def __init__(self, reset_at, emit_at, mode):
        self._loss = Loss()
        super(FeatsDistLossPluginMetric, self).__init__(
    ...
    def update(self, strategy):
        if(strategy.plugins[0].prev_model_frozen != None):
            ...
            self._loss.update(strategy.plugins[0].featureDistLoss,
                            patterns=len(strategy.mb_y), task_label=task_label)

class MinibatchFeatsDistLoss(FeatsDistLossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        """
        super(MinibatchFeatsDistLoss, self).__init__(
            reset_at='iteration', emit_at='iteration', mode='train')

    def __str__(self):
        return "FeatsDistLoss_MB"

class EpochFeatsDistLoss(FeatsDistLossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        super(EpochFeatsDistLoss, self).__init__(
            reset_at='epoch', emit_at='epoch', mode='train')

    def __str__(self):
        return "FeatsDist_Loss_Epoch"