...
class ILFGIR_plugin(StrategyPlugin):
    ...
    def after_forward(self, strategy: 'BaseStrategy', **kwargs):
        ...
        #print("----------")
        #print("Strategy mb out ", strategy.mb_output.size())
        #print("Strategy mb y ", strategy.mb_y)
    ...
    def before_backward(self, strategy: 'BaseStrategy', **kwargs):
        ...
        if self.prev_model_frozen is None:
            ...
            mmdLoss = mmd_loss(self.out_flattened_feature, frozen_prev_model_flattened_features)
            ...
            kdLoss = kd_loss(n_new_images, frozen_prev_model_logits, mb_old_class_logits)
            ...
            strategy.loss += mmdLoss + kdLoss + tripletLoss  #aggiungo alla cross entropy calcolata solo sulle nuove classi le altre loss
            print("Loss: ", strategy.loss)
    ...
    def after_eval_forward(self, strategy: 'BaseStrategy', **kwargs):
        ...
        strategy.out_flattened_features = strategy.mb_output[1]
        strategy.mb_output = strategy.mb_output[0]